...
import { useAudioPlayer } from "@sceneenglish/app-core/hooks/use-audio-player";
import {
  pageSizeForView,
  type WordsViewMode,
} from "@sceneenglish/api-client";
import { Button, Card, Input, PageHeader, Spinner } from "@sceneenglish/app-core/components/ui";
import { WordsViewSwitcher } from "@sceneenglish/app-core/components/words/view-switcher";
import { WordsAlphabetLayout } from "@sceneenglish/app-core/components/words/words-alphabet-layout";
import { WordsGridView } from "@sceneenglish/app-core/components/words/views/grid-view";
import { WordsListView } from "@sceneenglish/app-core/components/words/views/list-view";
