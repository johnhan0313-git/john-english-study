...
import { usePathname, useNavigate } from "../platform/navigation-hooks";
import { BookOpen, Home, Layers, Library } from "lucide-react";

import { cn } from "./utils";
import { prefetchNavTarget } from "./route-prefetch";
...
export function MobileBottomNav() {
  ...
  const prefetch = (href: string) => prefetchNavTarget(queryClient, platform.navigation, href);
