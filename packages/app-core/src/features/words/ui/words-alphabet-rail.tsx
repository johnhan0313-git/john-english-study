...
import { Card } from "../../../app-chrome/ui";
        ...
        createPortal(
          ...
          >
            <div className="animate-alphabet-bubble relative flex h-[4.25rem] w-[4.25rem] items-center justify-center">
              ...
              <div className="relative flex h-full w-full items-center justify-center rounded-2xl bg-gradient-to-br from-brand-400 to-brand-600 text-[2rem] font-bold text-white shadow-[0_12px_40px_rgba(255,146,104,0.32)]">
                {bubbleLetter}
              </div>
            </div>
          </div>,
